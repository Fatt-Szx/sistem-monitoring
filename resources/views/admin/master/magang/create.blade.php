            ...
            <div class="col-lg-12">
                ...
                <div class="card">
                    <div class="card-header">
                        <strong>Form Tambah</strong> Tempat Magang
                    </div>
                    ...
                    <div class="card-body card-block">
                        ...
                        <form action="{{ route('admin.master.magang.store') }}" method="POST" class="form-horizontal">
                            @csrf
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-9">
                                    <input type="text" name="nama"
                                           ...
                                           value="{{ old('nama') }}" required placeholder="Contoh: PT Maju Jaya">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-9">
                                    <textarea name="alamat" rows="3"
                                              ...
                                              placeholder="Jl. Contoh No. 123, Kec. Contoh">{{ old('alamat') }}</textarea>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-9">
                                    <input type="text" name="kab"
                                           ...
                                           value="{{ old('kab') }}" placeholder="Contoh: Sragen">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-9">
                                    <input type="text" name="provinsi"
                                           ...
                                           value="{{ old('provinsi') }}" placeholder="Contoh: Jawa Tengah">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-9">
                                    <input type="text" name="telepon"
                                           ...
                                           value="{{ old('telepon') }}" placeholder="Contoh: 021-123456 / 0812xxxxxxx">
